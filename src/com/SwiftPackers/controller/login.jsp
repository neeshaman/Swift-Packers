	...
	<div class="appointment-w3">
		...
		<form action="LoginServlet" method="post">
			...
			<div class="btnn">
				...
				<a href="ForgetPassword.jsp" class="for">Forgot password...?</a>
				<div class="clear"></div>
			</div>
			...
			<div class="header-social wthree">
				...
				<ul>
					<li><a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/Project_final/OAuth2Callback&response_type=code&client_id=660402214853-gi2t36f5ug1sog5ldoqh83tl8k5uvfcu.apps.googleusercontent.com&approval_prompt=force" class="g"><span class="fa fa-google" aria-hidden="true"></span>Login with Google</a></li>
				</ul>
			</div>
		</form>
	</div>
				...
				<div class="col-md-4 w3-agile-grid">
					...
					<div class="w3-address">
						...
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								<h6>Email Address</h6>
								<p>Email :<a href="mailto:example@email.com">heraferi2930@gmail.com</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="w3-address-grid">
