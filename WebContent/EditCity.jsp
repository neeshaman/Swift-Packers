...
<%@page import="com.SwiftPackers.bean.CityBean"%>
...
<!--//Metis Menu -->
	...
	<%
		String CityNameError = (String) request.getAttribute("CityNameError");//null
		String StateIdError = (String) request.getAttribute("StateIdError");
	%>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">Edit City Form:</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="UpdateCityServlet">
								<input type="hidden" class="form-control1" id="disabledinput" name="cityId" value="<%=bean.getCityId()%>" />
									...
									<div class="col-sm-8">
										<select class="form-control1" name="state">
											...
											<%
												String n, i;
												while (rs.next()) {
													i = rs.getString("state_id");
													n = rs.getString("state_name");

													if (bean.getStateId().equals(i)) {
											%>
											...
											%>
										</select><%=StateIdError == null ? "" : StateIdError%>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="cityName"	value="<%=bean.getCityName()%>" />
										<%=CityNameError == null ? "" : CityNameError%>
									</div>
								</div>
