					...
					<ul class="nav" id="side-menu">
					  ...
					  <!-- /nav-second-level -->
						...
						<li>
							...
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="ListCustomer.jsp">Customer<span class="nav-badge-btm"></span></a>								</li>
								<li>
									<a href="ListVendor.jsp">Vendor</a>								</li>
								<li>
									<a href="ListState.jsp">State</a>								</li>
								<li>
									<a href="ListCity.jsp">City</a>								</li>
								<li>
									<a href="ListPayment.jsp">Payment</a>								</li>
								<li>
									<a href="ListFeedback.jsp">Feedback</a>								</li>
								<li>
									<a href="ListService.jsp">Service</a>								</li>
								<li>
									<a href="ListRoute.jsp">Route</a>								</li>
								
								<li>
									<a href="ListFood.jsp">Food</a>								</li>
								<li>
									<a href="ListVehicle.jsp">Vehicle</a>								</li>
								<li>
									<a href="ListHousehold.jsp">Household</a>								</li>
								<li>
									<a href="ListAnimal.jsp">Animal</a>								</li>
								<li>
									<a href="ListOffice.jsp">Office</a>								</li>
							</ul>
							<!-- /nav-second-level -->
						</li>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="hoverable-table"> 
						...
						<table class="table table-hover"> <thead> <tr> <th>#</th> <th>First Name</th> <th>Last Name</th> <th>Username</th> </tr> </thead> <tbody> <tr> <th scope="row">1</th> <td>Mark</td> <td>Otto</td> <td>@mdo</td> </tr> <tr> <th scope="row">2</th> <td>Jacob</td> <td>Thornton</td> <td>@fat</td> </tr> <tr> <th scope="row">3</th> <td>Larry</td> <td>the Bird</td> <td>@twitter</td> </tr><tr border=0px><button>ADD</button></tr> </tbody> </table>
					</div>
			  </div>
			</div>
		</div>
