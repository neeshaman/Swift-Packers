...
<%@page import="com.SwiftPackers.bean.Service_vendorBean"%>
...
<!--//Metis Menu -->
	...
	<%
	Service_vendorBean bean = (Service_vendorBean) request.getAttribute("Service_vendorBean");
	%>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">Edit Service_Vendor Form:</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="UpdateService_vendorServlet">
								<input type="hidden" class="form-control1" id="disabledinput" name="ser_venId" value="<%=bean.getSer_venId()%>" />
								<div class="form-group">
									<label class="col-sm-2 control-label">Service Id</label>
									<div class="col-sm-8">
										<select class="form-control1" name="serviceId">
											<option value="-1">Please select Service</option>
											<%
												String n, i;
												while (rs.next()) {
													i = rs.getString("service_id");
													n = rs.getString("service_type");

													if (bean.getServiceId().equals(i)) {
											%>
										...
										<%=ServiceIdError == null ? "" : ServiceIdError%>
									</div>
								</div>
