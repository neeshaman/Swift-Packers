...
<!--//Metis Menu -->
	...
	<%
		ArrayList<Service_vendorBean> list =(ArrayList<Service_vendorBean>) request.getAttribute("Service_vendorList");
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Service_vendor Table:</h3>
					<div class="bs-example widget-shadow" data-example-id="hoverable-table">
						<table class="table table-hover">
							...
							%>
							<tr>
								<td><%=bean.getSer_venId()%></td>
								<td><%=bean.getServiceId()%></td>
								<td><%=bean.getUserId()%></td>
								<td><a href="EditService_vendorServlet?ser_venId=<%=bean.getSer_venId()%>">Edit</a> | <a
									href="DeleteService_vendorServlet?ser_venId=<%=bean.getSer_venId()%>">Delete</a></td>
							</tr>
