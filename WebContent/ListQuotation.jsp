...
<!--//Metis Menu -->
	...
	<%
		ArrayList<QuotationBean> list =(ArrayList<QuotationBean>) request.getAttribute("QuotationList");
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Quotation Table:</h3>
					<div class="bs-example widget-shadow" data-example-id="hoverable-table">
						<table class="table table-hover">
							...
							%>
							<tr>
								<td><%=bean.getQuotId()%></td>
								<td><%=bean.getQuotPrice()%></td>
		...
		try {
			...
			System.out.println("Error ListQuotation.jsp::");
			e.printStackTrace();
		}
	%>									
								...
								<td><%=bean.getIsApproved()%></td>
								<td><a href="EditQuotationServlet?quotId=<%=bean.getQuotId()%>">Edit</a> | <a
									href="DeleteQuotationServlet?quotId=<%=bean.getQuotId()%>">Delete</a></td>
							</tr>
							<%
								}
							%>
