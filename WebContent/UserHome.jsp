					...
					<div class="w3layouts-banner-top<%=i%>">
						...
						<div class="container">
							<div class="slider-info">
								...
								<div class="col-md-4" style="color:white; font-size:40px; font-weight:bolder;">
									<p>WE PROVIDE</p>
									<p>WORLD CLASS <span style="color:#df4b00;">LOGISTIC</span></p>
									<p>SERVICES</p>
								</div>
							</div>
						</div>
...
<%
		...
		try
		{
			...
			String VselectQ="select max_vehicle from public.vendor_detail";
			String cityselectQ="select count(*) from public.city";
			String clientselectQ="select count(*) from public.haulage where delivery_status='delivered'";
			...
			if(rs1.next())
			{
				...
				System.out.println("in citycount : " + countCity);
			}
			if(rs2.next())
			{
				countClient=Integer.parseInt(rs2.getString("count"));
				System.out.println("in usercount : "+ countClient);
			}
		}
		catch(Exception e)
		{
