<%@page import="com.SwiftPackers.bean.RouteBean"%>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
				...
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li>
							...
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="forms.jsp">Basic Forms <span class="nav-badge-btm">07</span></a>								
								</li>
								<li>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Route Table:</h3>
					<div class="bs-example widget-shadow" data-example-id="hoverable-table">
						<table class="table table-hover">
							...
							<tr>
								...
								<td><%=bean.getRouteVia()%></td>
								
								<td><a href="EditRouteServlet?routeId=<%=bean.getRouteId()%>">Edit</a> | <a
									href="DeleteRouteServlet?routeId=<%=bean.getRouteId()%>">Delete</a></td>
							</tr>
							...
							%>
							<tr>
								<td colspan="9" align="right"><a href="RouteForm.jsp"><button style="background-color: #e94e02;color: white;border: none;padding: 10px 25px;">ADD</button></a></td>
							</tr>
							</tbody> 
						</table>
					</div>
