...
<!--//Metis Menu -->
	...
	<%
	QuotationBean bean = (QuotationBean) request.getAttribute("QuotationBean");
	%>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">Edit Quotation Form :</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="UpdateQuotationServlet">
								<input type="hidden" class="form-control1" id="disabledinput" name="quotId" value="<%=bean.getQuotId()%>" />
								<input type="hidden" class="form-control1" id="disabledinput" name="custId" value="<%=bean.getCustId()%>" />
								<input type="hidden" class="form-control1" id="disabledinput" name="venId" value="<%=bean.getVenId()%>" />
								<input type="hidden" class="form-control1" id="disabledinput" name="haulId" value="<%=bean.getHaulId()%>" />
								<input type="hidden" class="form-control1" id="disabledinput" name="isApproved" value="<%=bean.getIsApproved()%>" />
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Quotation Price</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="quotPrice" value="<%=bean.getQuotPrice()%>" />
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="date" class="form-control1" id="focusedinput" required name="deliveryDate" value="<%=bean.getDeliveryDate()%>" />
