...
<!--//Metis Menu -->
	...
	<%
		ArrayList<ServiceBean> list = (ArrayList<ServiceBean>) request.getAttribute("ServiceList");
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Service Table:</h3>
						...
						<table class="table table-hover">
							...
							for (int i = 0; i < list.size(); i++)
							{
								...
								<tr>
									...
									<td><a href="EditServiceServlet?serviceId=<%=bean.getServiceId()%>">Edit</a> | <a
										href="DeleteServiceServlet?serviceId=<%=bean.getServiceId()%>">Delete</a></td>
								</tr>
							...
							%>
							<tr>
								<td colspan="9" align="right"><a href="ServiceForm.jsp"><button style="background-color: #e94e02;color: white;border: none;padding: 10px 25px;">ADD</button></a></td>
							</tr>
							</tbody> 
						</table>
					</div>
