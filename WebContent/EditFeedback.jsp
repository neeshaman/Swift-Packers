...
<%@page import="com.SwiftPackers.bean.FeedbackBean"%>
...
<!--//Metis Menu -->
	...
	<%
	FeedbackBean bean = (FeedbackBean) request.getAttribute("FeedbackBean");
	%>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">Edit Feedback Form :</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="UpdateFeedbackServlet">
								<input type="hidden" class="form-control1" id="disabledinput" name="feedId" value="<%=bean.getFeedId()%>" />
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Description</label>
									<div class="col-sm-8">
										<textarea class="form-control1" id="focusedinput" required name="description"><%=bean.getDescription()%></textarea>
