...
<!--//Metis Menu -->
	...
	<%
		ArrayList<CityBean> list =(ArrayList<CityBean>) request.getAttribute("CityList");
		CityBean bean = null;
	%>
<body class="cbp-spmenu-push">
	...
	<%
		...
		try {
			...
			String selectQ = "select * from state where state_id="+bean.getStateId();
			System.out.println(selectQ);
			rs = stmt.executeQuery(selectQ);
		} 
		catch (Exception e) {
			System.out.println("Error ListCity.jsp::");
			e.printStackTrace();
		}
	...
	%>									
							...
							<%}%>
								<td><a href="EditCityServlet?cityId=<%=bean.getCityId()%>">Edit</a> | <a
									href="DeleteCityServlet?cityId=<%=bean.getCityId()%>">Delete</a></td>
							</tr>
							...
							%>
							<tr>
								<td colspan="9" align="right"><a href="CityForm.jsp"><button style="background-color: #e94e02;color: white;border: none;padding: 10px 25px;">ADD</button></a></td>
							</tr>
							</tbody> 
						</table>
					</div>
