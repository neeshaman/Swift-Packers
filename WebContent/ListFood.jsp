...
<!--//Metis Menu -->
	...
	<%
		ArrayList<FoodBean> list = (ArrayList<FoodBean>) request.getAttribute("FoodList");
		FoodBean bean = null;
	%>
				...
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="hoverable-table">
						<table class="table table-hover">
							...
							%>
								<tr>
									<td><%=bean.getFoodId()%></td>
									<td><%=bean.getFoodType()%></td>
									<td><a href="EditFoodServlet?foodId=<%=bean.getFoodId()%>">Edit</a> | <a
										href="DeleteFoodServlet?foodId=<%=bean.getFoodId()%>">Delete</a></td>
								</tr>
							<%
								}
							%>
							<tr>
								<td colspan="9" align="right"><a href="FoodForm.jsp"><button style="background-color: #e94e02;color: white;border: none;padding: 10px 25px;">ADD</button></a></td>
							</tr>
							</tbody> 
						</table>
					</div>
