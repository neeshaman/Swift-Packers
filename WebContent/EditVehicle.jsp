...
<!--//Metis Menu -->
	...
	<%
	VehicleBean bean = (VehicleBean) request.getAttribute("VehicleBean");
	%>

	<%
		String VehicleTypeError = (String) request.getAttribute("VehicleTypeError");
		String VehicleCategoryError = (String) request.getAttribute("VehicleCategoryError");
	%>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">Edit Vehicle Form :</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="UpdateVehicleServlet">
								<input type="hidden" class="form-control1" id="disabledinput" name="vehicleId" value="<%=bean.getVehicleId()%>" />
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Vehicle Type</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="vehicleType" value="<%=bean.getVehicleType()==null? "":bean.getVehicleType() %>" />
										<%=VehicleTypeError == null ? "" : VehicleTypeError%>
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Vehicle Category</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="vehicleCategory" value="<%=bean.getVehicleCategory()==null? "":bean.getVehicleCategory() %>" />
										<%=VehicleCategoryError == null ? " " : VehicleCategoryError%>
									</div>
								</div>
