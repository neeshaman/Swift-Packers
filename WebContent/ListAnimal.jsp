...
<!--//Metis Menu -->
	...
	<%
		ArrayList<AnimalBean> list = (ArrayList<AnimalBean>) request.getAttribute("AnimalList");
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Animal Table:</h3>
					<div class="bs-example widget-shadow" data-example-id="hoverable-table">
						<table class="table table-hover">
							...
							%>
							<tr>
								<td><%=bean.getAnimalId()%></td>
								<td><%=bean.getAnimalType()%></td>
								<td><a href="EditAnimalServlet?animalId=<%=bean.getAnimalId()%>">Edit</a> | <a
									href="DeleteAnimalServlet?animalId=<%=bean.getAnimalId()%>">Delete</a></td>
							</tr>
							...
							%>
							<tr>
								<td colspan="9" align="right"><a href="AnimalForm.jsp"><button style="background-color: #e94e02;color: white;border: none;padding: 10px 25px;">ADD</button></a></td>
							</tr>
							</tbody> 
						</table>
					</div>
