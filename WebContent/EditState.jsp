...
<%@page import="com.SwiftPackers.bean.StateBean"%>
...
<!--//Metis Menu -->
	...
	<%
		StateBean bean = (StateBean) request.getAttribute("StateBean");
	%>

	<%
		String StateNameError = (String) request.getAttribute("StateNameError");
	System.out.println(StateNameError);
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">Edit State Form:</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="UpdateStateServlet">
								<input type="hidden" class="form-control1" id="disabledinput" name="stateId" value="<%=bean.getStateId()%>" />
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">State Name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="stateName" value="<%=bean.getStateName()==null?" ":bean.getStateName()%>"/>
										<%=StateNameError == null ? " " : StateNameError%>
									</div>
								</div>
