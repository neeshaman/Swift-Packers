...
<!--//Metis Menu -->
	...
	<%
		ArrayList<StateBean> list = (ArrayList<StateBean>) request.getAttribute("StateList");
		StateBean bean = null;
	%>
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">State Table:</h3>
					<div class="bs-example widget-shadow" data-example-id="hoverable-table">
						<table class="table table-hover">
							...
							%>
							<tr>
								<td><%=bean.getStateId()%></td>
								<td><%=bean.getStateName()%></td>
								<td><a href="EditStateServlet?stateId=<%=bean.getStateId()%>">Edit</a> |
									<a href="DeleteStateServlet?stateId=<%=bean.getStateId()%>">Delete</a></td>
							</tr>
							<%
								}
							%>
							<tr>
								<td colspan="9" align="right"><a href="StateForm.jsp"><button style="background-color: #e94e02;color: white;border: none;padding: 10px 25px;">ADD</button></a></td>
							</tr>
							</tbody> 
						</table>
					</div>
