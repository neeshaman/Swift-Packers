...
<%@page import="com.SwiftPackers.bean.HouseholdBean"%>
...
<!--//Metis Menu -->
	...
	<%
	HouseholdBean bean = (HouseholdBean) request.getAttribute("HouseholdBean");
	%>



	<%
		String HouseTypeError = (String) request.getAttribute("HouseTypeError");
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">Edit Household Form :</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="UpdateHouseholdServlet">
								<input type="hidden" class="form-control1" id="disabledinput" name="houseId" value="<%=bean.getHouseId()%>" />
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">House Type</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="houseType" value="<%=bean.getHouseType()==null? "":bean.getHouseType() %>" />
										<%=HouseTypeError == null ? "" : HouseTypeError%>
									</div>
								</div>
