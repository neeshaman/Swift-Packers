				...
				<div class="forms">
					<div class="row">
						...
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="RouteFormServlet">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Origin</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="origin" value="${OriginValue}" />
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="destination" value="${DestinationValue}" />
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select class="form-control1"  name="city">
											...
											%>
										</select><%=CityIdError == null ? "" : CityIdError%>
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Route Via</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="routeVia" value="${RouteViaValue}" />
