...
<!--//Metis Menu -->
	...
	<%
		UserTypeBean bean = (UserTypeBean) request.getAttribute("UserTypeBean");
	%>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">Edit User Type Form:</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="UpdateUserTypeServlet">
								<input type="hidden" class="form-control1" id="disabledinput" name="userTypeId" value="<%=bean.getUserTypeId()%>" />
								
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">User Type Name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="userTypeName" value="<%=bean.getUserTypeName()==null?"": bean.getUserTypeName()%>"/>
