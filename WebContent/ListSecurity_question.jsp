<%@page import="com.SwiftPackers.bean.Security_questionBean"%>
...
<!--//Metis Menu -->
	...
	<%
		ArrayList<Security_questionBean> list = (ArrayList<Security_questionBean>) request.getAttribute("Security_questionList");
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Security_question Table:</h3>
					<div class="bs-example widget-shadow" data-example-id="hoverable-table">
						<table class="table table-hover">
							<thead> 
								<tr>
									<th>Security_question Id</th>
							...
							%>
							<tr>
								<th><%=bean.getSecurity_questionId()%></th>
