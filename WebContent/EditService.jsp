...
<%@page import="com.SwiftPackers.bean.ServiceBean"%>
...
<!--//Metis Menu -->
	...
	<%
	ServiceBean bean = (ServiceBean) request.getAttribute("ServiceBean");
	%>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">Edit Service Form:</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="UpdateServiceServlet">
								<input type="hidden" class="form-control1" id="disabledinput" name="serviceId" value="<%=bean.getServiceId()%>" />
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Service Type</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="serviceType" value="<%=bean.getServiceType()==null?"": bean.getServiceType()%>"/>
										<%=ServiceTypeError == null ? "" : ServiceTypeError%>
									</div>
								</div>
