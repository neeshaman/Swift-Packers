...
<!--//Metis Menu -->
	...
	<%
		ArrayList<FeedbackBean> list =(ArrayList<FeedbackBean>) request.getAttribute("FeedbackList");
					...
					<div class="bs-example widget-shadow" data-example-id="hoverable-table">
						<table class="table table-hover">
							...
							for (int i = 0; i < list.size(); i++)
							{
								...
								%>
							<tr>
								<td><%=bean.getFeedId()%></td>
								<td><%=bean.getName()%></td>
								<td><%=bean.getDescription()%></td>
								<td><a href="EditFeedbackServlet?feedId=<%=bean.getFeedId()%>">Edit</a> |
									<a href="DeleteFeedbackServlet?feedId=<%=bean.getFeedId()%>">Delete</a></td>
							</tr>
							<%
								}
							%>
