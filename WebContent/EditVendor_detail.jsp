...
<%
		Vendor_detailBean bean = (Vendor_detailBean) request.getAttribute("Vendor_detailBean");
	%>
	...
	<%
		...
		try {
			...
			System.out.println("Error EditVendor_detail.jsp::in select city");
			e.printStackTrace();
		}
	%>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">Edit Vendor Details :</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="UpdateVendor_detailServlet">
								<input  type="hidden" class="form-control1" id="disabledinput" name="vendor_detailId"	value="<%=bean.getVendorDetailId()%>" />
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Address</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="address" value="<%=bean.getAddress() == null ? "" : bean.getAddress()%>" />
										<%=AddressError == null ? "" : AddressError%>
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Max_vehicle</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="maxVehicle" value="<%=bean.getMaxVehicle() == null ? "" : bean.getMaxVehicle()%>" />
										<%=MaxVehicleError == null ? "" : MaxVehicleError%>
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">License</label>
									<div class="col-sm-8">
									<img name="licence1" src="photos/<%=bean.getUserId()%>/<%=bean.getLicense()%>"	height="20%" width="20%">
									<%=LicenseError == null ? "" : LicenseError%>
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Company_name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="companyName" value="<%=bean.getCompanyName() == null ? "" : bean.getCompanyName()%>" />
