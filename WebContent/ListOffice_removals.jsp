<%@page import="com.SwiftPackers.bean.Office_removalsBean"%>
...
<!--//Metis Menu -->
	...
	<%
		ArrayList<Office_removalsBean> list = (ArrayList<Office_removalsBean>) request.getAttribute("Office_removalsList");
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Office_removals Table:</h3>
					<div class="bs-example widget-shadow" data-example-id="hoverable-table">
						<table class="table table-hover">
							...
							%>
							<tr>
								<td><%=bean.getOfficeId()%></td>
								<td><%=bean.getOfficeType()%></td>
								<td><a href="EditOffice_removalsServlet?officeId=<%=bean.getOfficeId()%>">Edit</a> | <a
									href="DeleteOffice_removalsServlet?officeId=<%=bean.getOfficeId()%>">Delete</a></td>
							</tr>
							...
							%>
							<tr>
								<td colspan="9" align="right"><a href="Office_removalsForm.jsp"><button style="background-color: #e94e02;color: white;border: none;padding: 10px 25px;">ADD</button></a></td>
							</tr>
							</tbody> 
						</table>
					</div>
