...
<%@page import="com.SwiftPackers.bean.FoodBean"%>
...
<!--//Metis Menu -->
	...
	<%
	FoodBean bean = (FoodBean) request.getAttribute("FoodBean");
	%>

	<%
		String FoodTypeError = (String) request.getAttribute("FoodTypeError");
	%>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">Edit Food Form :</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="UpdateFoodServlet">
								<input type="hidden" class="form-control1" id="disabledinput"  name="foodId" value="<%=bean.getFoodId()%>" />
															
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Food Type</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="foodType" value="<%=bean.getFoodType()==null? "":bean.getFoodType() %>" />
										<%=FoodTypeError == null ? "" : FoodTypeError%>
									</div>
								</div>
