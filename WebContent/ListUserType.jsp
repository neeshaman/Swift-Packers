<%@page import="com.SwiftPackers.bean.UserTypeBean"%>
...
<!--//Metis Menu -->
	...
	<%
		ArrayList<UserTypeBean> list = (ArrayList<UserTypeBean>) request.getAttribute("UserTypeList");
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">UserType Table:</h3>
					<div class="bs-example widget-shadow" data-example-id="hoverable-table">
						<table class="table table-hover">
							...
							%>
							<tr>
								<td><%=bean.getUserTypeId()%></td>
								<td><%=bean.getUserTypeName()%></td>
								<td><a href="EditUserTypeServlet?userTypeId=<%=bean.getUserTypeId()%>">Edit</a> | <a
									href="DeleteUserTypeServlet?userTypeId=<%=bean.getUserTypeId()%>">Delete</a></td>
							</tr>
							...
							%>
							<tr>
								<td colspan="9" align="right"><a href="UserTypeForm.jsp"><button style="background-color: #e94e02;color: white;border: none;padding: 10px 25px;">ADD</button></a></td>
							</tr>
							</tbody> 
						</table>
					</div>
