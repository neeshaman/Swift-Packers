...
<!--//Metis Menu -->
	...
	<%
		ArrayList<VehicleBean> list = (ArrayList<VehicleBean>) request.getAttribute("VehicleList");
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Vehicle Table:</h3>
					<div class="bs-example widget-shadow" data-example-id="hoverable-table">
						<table class="table table-hover">
							...
							<tr>
								...
								<td><%=bean.getVehicleCategory()%></td>
								<td><a href="EditVehicleServlet?vehicleId=<%=bean.getVehicleId()%>">Edit</a> | <a
									href="DeleteVehicleServlet?vehicleId=<%=bean.getVehicleId()%>">Delete</a></td>
							</tr>
							...
							%>
							<tr>
								<td colspan="9" align="right"><a href="VehicleForm.jsp"><button style="background-color: #e94e02;color: white;border: none;padding: 10px 25px;">ADD</button></a></td>
							</tr>
							</tbody> 
						</table>
					</div>
